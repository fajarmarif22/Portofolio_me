...
function Projectcard({imgUrl, title, description, urlLink}) {
  return (
  <div>
    <div className="h-52 md:h-72 rounded-t-xl relative group" style={{background: `url(${imgUrl})`, backgroundSize:"cover"}}>
      ...
      <a href={urlLink} target="_blank" className="h-14 w-14 mr-2 border-2 relative rounded-full border-[#ADB7BE] hover:border-white group/link">
